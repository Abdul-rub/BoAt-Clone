import {
  ...
  export function CatchthemAll() {
    ...
    const handleNewLaunches = async() => {
        try {
          let res = await fetch('http://localhost:8000/product/newlaunch');
          let newLaunch = await res.json();
          setData(newLaunch);
          setValue("1");
    ...
    const handleMarvel = async() => {
        try {
          let res = await fetch('http://localhost:8000/product/marvel');
          let marvel = await res.json();
          setData(marvel);
          setValue("2");
    ...
    const handleDC = async() => {
      try {
        let res = await fetch('http://localhost:8000/product/dc');
        let DC = await res.json();
        setData(DC);
        setValue("3");
